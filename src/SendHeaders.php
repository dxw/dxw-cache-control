...
class SendHeaders implements \Dxw\Iguana\Registerable
{
    ...
    protected $overridesArchive = false;
    protected $developerMode = false;
    protected $currentConfig = 'default';
    protected $pageProperties = [];
    protected $homePageCacheAge = 'default';
    protected $frontPageCacheAge = 'default';
    protected $archiveCacheAge = 'default';
    ...
    public function setCacheHeader()
    {
        ...
        if (count($this->pageProperties) > 0) {
            ...
            if ($this->pageProperties['isLoggedInUser'] && !$this->developerMode) {
                return header('Cache-Control: no-cache, private');
            }
    ...
    protected function getPageProperties(): void
    {
        ...
        if ($this->developerMode) {
            if (count($this->pageProperties) > 0) {
                ...
                header('Meta-cc-properties-error: "No available page properties"');
            }
        }
    }

...
{
    protected $templates = [];
    protected $hasCustomTemplates = false;
        ...
        foreach ($this->templates as $postType => $postTypeTemplates) {
            foreach ($postTypeTemplates as $templateFile => $templateName) {
                ...
                $templateSubFields = [
                    ...
                    [
                        'key' => 'field_cache_control_template_'.$postType->name.'_override_taxonomy',
                        'label' => 'Overrides taxonomy cache age',
                        'name' => 'cache_control_template_'.$postType->name.'_override_taxonomy',
                        'type' => 'true_false',
